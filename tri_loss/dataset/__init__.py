...
def create_dataset(
  ...
  if name == 'market1501':
    im_dir = ospeu('../reid-datasets/beyond-part-models/market1501/images')
    partition_file = ospeu('../reid-datasets/beyond-part-models/market1501/partitions.pkl')

  elif name == 'cuhk03':
    im_type = ['detected', 'labeled'][0]
    im_dir = ospeu(ospj('../reid-datasets/beyond-part-models/cuhk03', im_type, 'images'))
    partition_file = ospeu(ospj('../reid-datasets/beyond-part-models/cuhk03', im_type, 'partitions.pkl'))

  elif name == 'duke':
    im_dir = ospeu('../reid-datasets/beyond-part-models/duke/images')
    partition_file = ospeu('../reid-datasets/beyond-part-models/duke/partitions.pkl')

  elif name == 'combined':
    assert part in ['trainval'], \
      "Only trainval part of the combined dataset is available now."
    im_dir = ospeu('../reid-datasets/beyond-part-models/market1501_cuhk03_duke/trainval_images')
    partition_file = ospeu('../reid-datasets/beyond-part-models/market1501_cuhk03_duke/partitions.pkl')
